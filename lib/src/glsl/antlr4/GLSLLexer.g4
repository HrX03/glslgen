...
NOPERSPECTIVE: 'noperspective'; //ignores ES mode
SAMPLE: 'sample'; //ignores ES mode
PATCH: 'patch'; //ignores ES mode
COHERENT: 'coherent'; //unclear, depends on extension
RESTRICT: 'restrict'; //unclear, depends on extension
READONLY: 'readonly'; //unclear, depends on extension
WRITEONLY: 'writeonly'; //unclear, depends on extension
SUBROUTINE: 'subroutine'; //ignores ES mode
DEVICECOHERENT: 'devicecoherent'; //unclear, depends on extension
QUEUEFAMILYCOHERENT:
	'queuefamilycoherent'; //unclear, depends on extension
WORKGROUPCOHERENT:
	'workgroupcoherent'; //unclear, depends on extension
SUBGROUPCOHERENT:
	'subgroupcoherent'; //unclear, depends on extension
NONPRIVATE: 'nonprivate'; //unclear, depends on extension
...
ATOMIC_UINT: 'atomic_uint'; //ignores ES mode
STRUCT: 'struct';
IF: 'if';
ELSE: 'else';
SWITCH: 'switch';
...
SAMPLER1DARRAYSHADOW: 'sampler1DArrayShadow'; //ignores ES mode
SAMPLER2DARRAYSHADOW: 'sampler2DArrayShadow';
ISAMPLER1D: 'isampler1D'; //ignores ES mode
ISAMPLER2D: 'isampler2D';
ISAMPLER2DRECT: 'isampler2DRect'; //ignores ES mode
ISAMPLER3D: 'isampler3D';
ISAMPLER1DARRAY: 'isampler1DArray'; //ignores ES mode
ISAMPLER2DARRAY: 'isampler2DArray';
USAMPLER1D: 'usampler1D'; //ignores ES mode
USAMPLER2D: 'usampler2D';
USAMPLER2DRECT: 'usampler2DRect'; //ignores ES mode
USAMPLER3D: 'usampler3D';
USAMPLER1DARRAY: 'usampler1DArray'; //ignores ES mode
USAMPLER2DARRAY: 'usampler2DArray';
SAMPLER2DMS: 'sampler2DMS'; //ignores ES mode;
ISAMPLER2DMS: 'isampler2DMS'; //ignores ES mode;
USAMPLER2DMS: 'usampler2DMS'; //ignores ES mode;
SAMPLER2DMSARRAY: 'sampler2DMSArray'; //ignores ES mode;
ISAMPLER2DMSARRAY: 'isampler2DMSArray'; //ignores ES mode;
USAMPLER2DMSARRAY: 'usampler2DMSArray'; //ignores ES mode;
...
SAMPLERBUFFER: 'samplerBuffer'; //ignores ES mode
ISAMPLERBUFFER: 'isamplerBuffer'; //ignores ES mode
USAMPLERBUFFER: 'usamplerBuffer'; //ignores ES mode
...
NR_VERSION: 'version';
NR_CUSTOM: 'custom' -> pushMode(CustomDirective);
NR_INCLUDE: 'include';
NR_PRAGMA: 'pragma';
...
NR_STRING_START: '"' -> pushMode(StringContent);
NR_STRING_START_ANGLE: '<' -> pushMode(StringAngle);
